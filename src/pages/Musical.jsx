...
import logoCartao from "../assets/mcdb-logo-card.png"
...
async function fazerUploadCapa(arquivo) {
  ...
  async function salvarEdicaoMusical() {
    ...
    const fontesLimpas = fontesEdicao
          ...
          {(jaVi || votoAtual) && (
            <div style={{ marginTop: "16px", marginBottom: "8px" }}>
              <div ref={cartaoRef} style={{ position: "absolute", left: "-9999px", top: "-9999px", background: "linear-gradient(160deg, #2f2f2f 0%, #1c1c1c 100%)", width: "270px", height: "480px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingTop: "50px", paddingBottom: "56px", paddingLeft: "28px", paddingRight: "28px", boxSizing: "border-box" }}>
                ...
                <img src={logoCartao} alt="MCDb" style={{ width: "76px", height: "auto", marginBottom: "5px", opacity: 0.95 }} />
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "6px" }}>
                {musical.fontes.filter(f => f && f.descricao).map((f, i) => (
                  <li key={i} style={{ fontSize: "13px", color: "#666", lineHeight: 1.4 }}>
                    {f.link ? (
                      <a href={f.link} target="_blank" rel="noopener noreferrer" style={{ color: "#b8960a", textDecoration: "none", borderBottom: "1px dotted #b8960a" }}>
                        {f.descricao}
                      </a>
                    ) : (
                      f.descricao
