...
function CardMusical({
  ...
  // Bloco de listas (dropdown), reaproveitado nos dois tamanhos.
  // Nos cards pequenos abre para BAIXO (para não ser cortado pelo overflow do carrossel).
  ...
  // Barra de botões de hover (Já vi / Quero ver / Listas), reaproveitada nos dois tamanhos.
